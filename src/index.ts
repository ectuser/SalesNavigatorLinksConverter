...
function convertMultipleSalesNavigatorLinks(salesNavigatorLinks: string[], options: ISalesNavigatorConverterOptions = salesNavigatorConverterDefaultOptions) : string[]{
    ...
    for (let link of salesNavigatorLinks){
        ...
        try {
            ...
            else if (error instanceof RegexMatchError && !options.strictMode){
...
function convertSalesNavigatorLink(link: string){
    // template - https://www.linkedin.com/sales/people/ACwAAADesZ8BkzsAiMtKrLgIbVOh23MGN9mPUXM,NAME_SEARCH,OCaE?_ntb=inVK0P7mS3qRTYjpxGalTg%3D%3D
...
const links = ["https://www.linkedin.com/sale/people/ACwAAACAlGcB3ekSocf6RLAcBY6T8cxs85iszb0,NAME_SEARCH,1eb2?_ntb=xfImurByQtaDeDyrb9pJmg%3D%3D", "https://www.linkedin.com/sales/people/ACwAAADesZ8BkzsAiMtKrLgIbVOh23MGN9mPUXM,NAME_SEARCH,OCaE?_ntb=inVK0P7mS3qRTYjpxGalTg%3D%3D"];

console.log(convertMultipleSalesNavigatorLinks(links, {skipInvalidURLs: "-1"}));